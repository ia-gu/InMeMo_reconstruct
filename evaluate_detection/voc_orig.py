...
class VOCDetection4Val(VisionDataset):
    ...
    def __init__(self,
        ...
        for year, image_set in zip(years, image_sets):
            ...
            if image_set == 'train':
                file_names = self.extract_fns_train()
...
class VOCDetection4Train(VisionDataset):
    """`Pascal VOC <http://host.robots.ox.ac.uk/pascal/VOC/>`_ Detection Dataset.
    Args:
        root (string): Root directory of the VOC Dataset.
        year (string, optional): The dataset year, supports years 2007 to 2012.
    ...
    def __init__(self,
        ...
        for year, image_set in zip(years, image_sets):
            ...
            if image_set == 'train':
                file_names = self.extract_fns_support_set()

            else:
                file_names = self.extract_fns_query_set()
    ...
    def extract_fns_query_set(self):
    ...
    def extract_fns_support_set(self):
